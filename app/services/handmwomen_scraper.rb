...
class HandmwomenScraper
  ...
  def product_links
    response = RestClient.get("http://api.hm.com/v2/us/en/products/display?page=2&categories=ladies&concealCategories=true&pageSize=60&deviceType=DESKTOP")
